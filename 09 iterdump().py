...
with sq.connect('saper.db') as con:
    ...
    # with open("sql_dump.sql", 'w') as f:  # save DB to txt file as SQLite command - using that command DB can be totally restored
    #     for sql in con.iterdump():
    #         f.write(sql)

    with open("sql_dump.sql", 'r') as f: # recover DB from txt file
        sql = f.read()
